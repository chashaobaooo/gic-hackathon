    ...
    <main className="min-h-screen flex flex-col items-center">
      <div className="flex-1 w-full flex flex-col gap-8 items-center">
        ...
        <div className="flex-1 w-full max-w-6xl p-6">
          <div className="mb-8">
            <h1 className="text-3xl font-bold mb-2">Reporting Analyst Dashboard</h1>
            <p className="text-muted-foreground">
              Monitor financial reports, analyze performance metrics, and generate insights
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              <h3 className="text-lg font-semibold mb-2">Assets Under Management</h3>
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <div className="text-3xl font-bold text-yellow-600 mb-1">Medium</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center p-3 border rounded">
                  <div>
                    <div className="font-medium">Quarterly Holdings Analysis</div>
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <div className="space-y-3">
                <button className="w-full p-3 text-left border rounded hover:bg-primary/5 transition-colors">
                  ...
                  <div className="text-sm text-muted-foreground">Create detailed performance analysis</div>
                </button>
                <button className="w-full p-3 text-left border rounded hover:bg-primary/5 transition-colors">
                  <div className="font-medium">Risk Analysis Dashboard</div>
                  <div className="text-sm text-muted-foreground">View current risk metrics and trends</div>
                </button>
                <button className="w-full p-3 text-left border rounded hover:bg-primary/5 transition-colors">
                  <div className="font-medium">Export Data</div>
                  <div className="text-sm text-muted-foreground">Download reports in various formats</div>
                </button>
                <button className="w-full p-3 text-left border rounded hover:bg-primary/5 transition-colors">
                  <div className="font-medium">Schedule Report</div>
                  <div className="text-sm text-muted-foreground">Set up automated report generation</div>
                </button>
              </div>
            </div>
          </div>
